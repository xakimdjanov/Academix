...
const Journals = () => {
  ...
  useSEO({
    title: t("journals.h1") + " | Academix.uz",
    description: "Academix / Akademix.uz — O'zbekistonning barcha sohalardagi yuqori sifatli, nufuzli va taqrizdan o'tgan ilmiy jurnallari ro'yxati.",
    keywords: "Academix, Academix.uz, ilmiy jurnallar ro'yxati, o'zbekiston ilmiy jurnallari",
    ...
    <div className="bg-[#F6F8FB] min-h-screen">
      ...
      <section className="bg-[#002147] text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-black mb-6">{t("journals.h1")}</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 pb-24">
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-3xl shadow-sm border border-gray-100">
             ...
             <h3 className="text-2xl font-bold text-[#002147] mb-2">{t("journals.not_found")}</h3>
...
const JournalCard = ({ journal }) => {
  ...
  const defaultDesc = language === "uz" 
    ? "O'z sohasidagi ilmiy ma'lumotlarning yetakchi manbasi." 
    : language === "en" 
    ? "The leading source of scientific information in its field." 
    : "Ведущий источник научной информации в своей области.";
    ...
    <div className="bg-white rounded-[2rem] p-8 shadow-sm hover:shadow-2xl transition-all border border-gray-50 group flex flex-col h-full">
      <div className="flex justify-between items-start mb-6">
         ...
         <span className="px-3 py-1 bg-blue-50 text-blue-600 text-[10px] font-black uppercase rounded-full tracking-widest">
           {translateCategory(journal.category) || (language === "uz" ? "Ilmiy" : language === "en" ? "Scientific" : "Научный")}
         </span>
      </div>
      ...
      <p className="text-[#6B7280] text-sm line-clamp-3 mb-6 flex-grow leading-relaxed">
        {journal.description || journal.short_description || defaultDesc}
      </p>
      ...
      <div className="flex flex-col gap-4 pt-6 border-t border-gray-50">
         <div className="flex items-center justify-between text-xs font-bold text-gray-400">
            ...
            <span className="flex items-center gap-1 text-blue-600">
               <FiEye size={14}/> {journal.view_count || 0} {t("common.views_count")}
            </span>
         </div>
         <div className="flex gap-2">
           ...
           >
              {t("home.hero_btn_submit").toUpperCase()}
           </Link>
         </div>
      </div>
    </div>
