          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <div className="mt-4 md:mt-0 flex justify-center md:justify-end">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                ...
                <span className="text-white text-sm">Xavfsiz Tizim</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-8">
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 md:p-6 lg:p-8">
                <h3 className="text-lg md:text-xl font-bold text-[#1F2937] mb-1 md:mb-2">
                  Shaxsiy va Professional ma'lumotlar
                </h3>
                <p className="text-[#6B7280] text-sm mb-6 md:mb-8">
                  Barcha yulduzcha (*) bilan belgilangan maydonlarni to'ldirish shart.
                </p>
                  ...
                  <Field
                    ...
                    input={
                      <input
                        ...
                        onChange={onChange}
                        placeholder="Universitet / Institut nomi"
                        className={inputCls}
                      />
                    }
                  />
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full px-6 py-3 md:px-8 md:py-4 bg-gradient-to-r from-[#1F4F8F] to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl font-semibold text-sm md:text-base transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed shadow-lg active:scale-[0.98]"
                    >
                      {loading ? (
